...
public class TokenController {
    ...
    public ResponseEntity<Void> publishToken(@RequestHeader("X-Custom-UserId") String userId) {
        ...
        TokenAdminDTOResult tokenAdminDTOResult = tokenAdminFacade.publishToken(TokenAdminDTOParam.builder()
                                                                                            .userId(userId)
                                                                                            .build());
        ...
        headers.set("X-Custom-UserId", tokenAdminDTOResult.userId());
